...
abstract class $KanbanStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<Board> boards, Status status});
}
...
class _$_KanbanState implements _KanbanState {
  const _$_KanbanState({this.boards = const [], required this.status});
  ...
  @override
  String toString() {
    return 'KanbanState(boards: $boards, status: $status)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, const DeepCollectionEquality().hash(boards), status);
